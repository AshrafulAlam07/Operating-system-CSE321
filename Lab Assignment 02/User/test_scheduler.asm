...
user/_test_scheduler:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  12:	8c258593          	addi	a1,a1,-1854 # 8d0 <malloc+0xfa>
  16:	4509                	li	a0,2
  18:	6e0000ef          	jal	6f8 <fprintf>
    exit(1);
  1c:	4505                	li	a0,1
  1e:	2d4000ef          	jal	2f2 <exit>
  }

  int n = atoi(argv[1]);
  22:	6588                	ld	a0,8(a1)
  24:	1ac000ef          	jal	1d0 <atoi>
  if(n <= 0){
  28:	00a05763          	blez	a0,36 <main+0x36>
    fprintf(2, "tickets must be positive\n");
    exit(1);
  }

  if(settickets(n) < 0){
  2c:	356000ef          	jal	382 <settickets>
  30:	00054d63          	bltz	a0,4a <main+0x4a>
  ...
  3a:	8c258593          	addi	a1,a1,-1854 # 8f8 <malloc+0x122>
  3e:	4509                	li	a0,2
  40:	6b8000ef          	jal	6f8 <fprintf>
    exit(1);
  44:	4505                	li	a0,1
  46:	2ac000ef          	jal	2f2 <exit>
    fprintf(2, "settickets failed\n");
  4a:	00001597          	auipc	a1,0x1
  4e:	8ce58593          	addi	a1,a1,-1842 # 918 <malloc+0x142>
  52:	4509                	li	a0,2
  54:	6a4000ef          	jal	6f8 <fprintf>
    exit(1);
  58:	4505                	li	a0,1
